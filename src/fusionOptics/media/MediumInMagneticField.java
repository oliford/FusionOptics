...
public class MediumInMagneticField extends Medium {
	...
	public void rayPropagation(RaySegment ray) {
		...
		try{
			...
			throw new RuntimeException("Error propagating in medium " + 
											((ray == null || ray.medium == null) ? "(null)" : ray.medium.getClass().getName()) + 
											" made of material " + 
											((material == null) ? "(null)" : material.getClass().getName()) + 
											" between surfaces " + 
											((ray == null || ray.startHit == null) ? "(null)" : ray.startHit.surface.getName()) + 
											" and " +
											((ray == null || ray.endHit == null) ? "(null)" : ray.endHit.surface.getName()), err);
		}
