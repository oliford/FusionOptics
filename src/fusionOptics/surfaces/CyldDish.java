...
/** Cylindrical Surface - Part of the surface of cylinder.
 */
public class CyldDish extends Surface {
	...
	public CyldDish(String name, double centre[], double dishCentreNormal[], double up[], double radiusOfCurvature, double width, double rimRadius, Interface iface) {
	 ...
	 * @param interfaceType
	 */
	public CyldDish(String name, double centre[], double dishCentreNormal[], double up[], double radiusOfCurvature, double width, double height,
